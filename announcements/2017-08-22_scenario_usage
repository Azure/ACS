...
sauryadas$ az network vnet create -g vnetrg -n vnet007
{
  "newVNet": {
    "addressSpace": {
      "addressPrefixes": [
    ...
    "etag": "W/\"b9d58e4e-b650-4fc1-ad50-726d6af216d0\"",
    "id": "/subscriptions/5abfd9c4-ec8c-4db9-acd4-c762dce93508/resourceGroups/vnetrg/providers/Microsoft.Network/virtualNetworks/vnet007",
    "location": "westindia",
    "name": "vnet007",
    "provisioningState": "Succeeded",
    "resourceGroup": "vnetrg",
    "resourceGuid": "bd645c18-097d-4fb2-8a3a-287513a70790",
    "subnets": [],
    "tags": {},
...
$ az acs create -n vnetcs -g vnetrg -t kubernetes --agent-vnet-subnet-id "/subscriptions/5abfd9c4-ec8c-4db9-acd4-c762dce93508/resourceGroups/vnetrg/providers/Microsoft.Network/virtualNetworks/vnet007"

*Use the VNET id and specifiy a custom port*
$ az acs create -n portvnetcs -g vnetrg -t kubernetes --agent-vnet-subnet-id "/subscriptions/5abfd9c4-ec8c-4db9-acd4-c762dce93508/resourceGroups/vnetrg/providers/Microsoft.Network/virtualNetworks/vnet007" --agent-ports 4005
